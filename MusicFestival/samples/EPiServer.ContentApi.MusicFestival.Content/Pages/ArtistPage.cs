...
namespace EPiServer.ContentApi.MusicFestival.Content
{
    [ContentType(DisplayName = "Artist Page", GUID = "9e98d26a-6f06-4c35-bfbd-8b850a0fa433", Description = "")]
    public class ArtistPage : PageData
    {
        [Display(
            Name = "Artist Name",
